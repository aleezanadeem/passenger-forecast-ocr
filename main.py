...
# ========= CONFIG =========
RAW_FOLDER_ID = "1BhB3pZWxOMcTXZcmYzrxwtgNwp8dg9pX"   # <-- RAW folder ID
SHEET_NAME = "Passenger Forecast Data"                # <-- target sheet
LOG_SHEET_NAME = "Log"                                # <-- log tab
# ==========================
...
for file in reversed(new_files):  # oldest first
    ...
    for row in rows:
        ...
        date = row[2].replace(",", "")
        year = row[3]
        numbers = row[4:18]  # expected 14 numbers max
